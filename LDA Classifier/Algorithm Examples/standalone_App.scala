...
object standalone_App {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var Array(trainingDS, testingDS) = scalermodel.transform(Alldata).randomSplit(Array(0.8, 0.2) , seed = 10 )
